...
def main():
    ...
    N = 1000 # The size of dataset
    n_run = 15 # The number of rounds
    ...
    models_loss = [] # train losses for models
    models_acc = [] # test accuracy for models
    for name in model_names:
      runs_loss = [] # train losses for each run
      runs_accuracy = [] # test accuracy for each run
      for i in range(n_run):
        ...
        train_input, test_input = standardize(train_input, test_input) # standardize the dataset
        ...
        elif 'Siamese_version1_auxiliary_loss' == name:
          print(name)
    ...
    plot_train_loss_test_accuracy(models_loss, models_acc, model_names) # plot the train losses and test accuracy of different models
